                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <?php if($voi['pic'] != ''): ?>
                                    <img src="http://127.0.0.1/landl/public/static<?php echo $voi['pic']; ?>" height="50">
                                    <?php else: ?>暂无图片
                                    <?php endif; ?>
                                </td>
                                ...
                                <td align="center">
                                    <a href="<?php echo url('Article/edit',array('id'=>$voi['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <?php if($voi['id'] != 8): ?>
                                    <a href="#" onClick="warning('确实要删除吗', '<?php echo url('Article/del',array('id'=>$voi['id'])); ?>')" class="btn btn-danger btn-sm shiny">
