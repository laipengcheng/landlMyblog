        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo url('Article/lit'); ?>">文章管理</a>
                    </li>
                                    ...
                                    <form class="form-horizontal" role="form" action="" enctype="multipart/form-data" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <?php if($articles['pic'] != ''): ?>
                                                <img src="http://127.0.0.1/landl/public/static<?php echo $articles['pic']; ?>" height="50">
                                                <?php else: ?>
                                                暂无图片
                                                <?php endif; ?>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <div id="editor" style="min-width: 120%"><?php echo $articles['content']; ?></div>
                                                <textarea style="display: none" id="content" name="content" style="width:100%; height:400px;"></textarea>
                                            </div>
                                        </div>
...
<script src="http://127.0.0.1/landl/public/static/admin/wangEditor/src/js/xss/xss.js"></script>
<script type="text/javascript" src="http://127.0.0.1/landl/public/static/admin/wangEditor/release/wangEditor.min.js"></script>
