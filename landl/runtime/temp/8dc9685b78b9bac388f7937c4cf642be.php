<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"E:\phpStudy\PHPTutorial\WWW\landl\public/../application/admin\view\article\add.html";i:1540708472;s:72:"E:\phpStudy\PHPTutorial\WWW\landl\application\admin\view\common\top.html";i:1540287110;s:73:"E:\phpStudy\PHPTutorial\WWW\landl\application\admin\view\common\left.html";i:1540525157;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" enctype="multipart/form-data" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="input-large" id="pic" placeholder="" name="pic" type="file">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <label>
                                    <input class="checkbox-slider yesno" type="checkbox" name="state" id="state">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div id="editor" style="min-width: 120%"></div>
                                <textarea style="display: none" id="content" name="content" style="width:100%; height:200px;"></textarea>
                            </div>
                        </div>
