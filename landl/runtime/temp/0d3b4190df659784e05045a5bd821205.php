                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <a href="#">系统</a>
                                        ...
                                        <li>
                        <a href="<?php echo url('cate/lit'); ?>">栏目管理</a>
                    </li>
                    <li class="active">栏目管理员</li>
                                        </ul>
                </div>
                <!-- /Page Breadcrumb -->
