<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:64:"/home/WWW/landl/public/../application/admin/view/admin/edit.html";i:1541664754;s:54:"/home/WWW/landl/application/admin/view/common/top.html";i:1541665464;s:55:"/home/WWW/landl/application/admin/view/common/left.html";i:1541665884;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="username" placeholder="" name="username" required="" value="<?php echo $admins['username']; ?>" type="text">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <p class="help-block col-sm-4 red">* 可不修改</p>
                        </div>  
                        <div class="form-group">
