<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"E:\phpStudy\PHPTutorial\WWW\landl\public/../application/admin\view\download\lit.html";i:1541491629;s:72:"E:\phpStudy\PHPTutorial\WWW\landl\application\admin\view\common\top.html";i:1540730385;s:73:"E:\phpStudy\PHPTutorial\WWW\landl\application\admin\view\common\left.html";i:1541491558;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
...
<body>
                        ...
                        <li>
                            <a class="login-area dropdown-toggle" data-toggle="dropdown">
                                <div class="avatar" title="View your public profile">
                                    <img src="http://127.0.0.1/landl/public/static/admin/images/adam-jansen.jpg">
                                </div>
                                <section>
    ...
    <ul class="nav sidebar-menu">
        ...
        <li>
            ...
            <ul class="submenu">
                <li>
                    <a href="<?php echo url('Article/lit'); ?>">
                                    <span class="menu-text">
                                        文章列表                                   </span>
                        <i class="menu-expand"></i>
                    </a>
        ...
        <li>
            ...
            <ul class="submenu">
                <li>
                    <a href="<?php echo url('download/lit'); ?>">
                                    <span class="menu-text">
                                        下载列表                                   </span>
                        <i class="menu-expand"></i>
                    </a>
...
<button type="button" tooltip="添加链接" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href='<?php echo url('download/add'); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
                    ...
                    <table class="table table-bordered table-hover">
                        <thead class="">
                            <tr>
                                ...
                                <th class="text-center" >下载编号</th>
                                <th class="text-center" >下载地址</th>
                                <th class="text-center" >下载密码</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center"><a href="<?php echo $voi['url']; ?>" target="_blank"><?php echo $voi['url']; ?></td>
                                <td align="center">
                                    <?php echo $voi['pass']; ?>
                                </td>
                                <td align="center">
                                    <a href="<?php echo url('download/edit',array('id'=>$voi['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <?php if($voi['id'] != 8): ?>
                                    <a href="#" onClick="warning('确实要删除吗', '<?php echo url('download/del',array('id'=>$voi['id'])); ?>')" class="btn btn-danger btn-sm shiny">
