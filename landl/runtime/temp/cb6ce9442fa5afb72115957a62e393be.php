<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"/home/WWW/landl/public/../application/admin/view/cate/edit.html";i:1541664784;s:54:"/home/WWW/landl/application/admin/view/common/top.html";i:1541665464;s:55:"/home/WWW/landl/application/admin/view/common/left.html";i:1541665884;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                        ...
                        <li>
                            <a class="login-area dropdown-toggle" data-toggle="dropdown">
                                <div class="avatar" title="View your public profile">
                                    <img src="/public/static/admin/images/adam-jansen.png">
                                </div>
                                <section>
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <a href="#">系统</a>
                                        ...
                                        <li>
                        <a href="<?php echo url('cate/lit'); ?>">关键字管理</a>
                    </li>
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">修改关键字</span>
            </div>
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        ...
                        <div class="form-group">
                            <label for="catename" class="col-sm-2 control-label no-padding-right">关键字名称</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="catename" placeholder="" name="catename" required="" value="<?php echo $cates['catename']; ?>" type="text">
                            </div>
