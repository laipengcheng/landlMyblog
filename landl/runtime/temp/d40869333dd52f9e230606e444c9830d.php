<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:66:"/home/WWW/landl/public/../application/index/view/search/index.html";i:1541598890;s:57:"/home/WWW/landl/application/index/view/common/header.html";i:1541646700;s:56:"/home/WWW/landl/application/index/view/common/right.html";i:1541596812;s:57:"/home/WWW/landl/application/index/view/common/rright.html";i:1541082308;s:55:"/home/WWW/landl/application/index/view/common/foot.html";i:1541082142;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
    <title>landl</title>
...
<!--首页图片-->
<div class="other-img"><img src="/static/index/images/img01.jpg"></div>
<!--顶部结束-->

<div id="middle">
<!--左侧开始-->
    <div id="left">
        <div class="h2css"><h2 class="titleH2">搜索内容</h2></div>
        <?php if(is_array($searchres) || $searchres instanceof \think\Collection || $searchres instanceof \think\Paginator): $i = 0; $__LIST__ = $searchres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($vo['pic'] != ''): ?>
