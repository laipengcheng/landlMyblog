<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"/home/WWW/landl/public/../application/admin/view/admin/lit.html";i:1541664760;s:54:"/home/WWW/landl/application/admin/view/common/top.html";i:1541665464;s:55:"/home/WWW/landl/application/admin/view/common/left.html";i:1541665884;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                    ...
                    <table class="table table-bordered table-hover">
                        <thead class="">
                            <tr>
                                ...
                                <th class="text-center" width="168px">操作</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center"><?php echo $voi['username']; ?></td>
                                <td align="center">
                                    <a href="<?php echo url('admin/edit',array('id'=>$voi['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <?php if($voi['id'] != 8): ?>
                                    <a href="#" onClick="warning('确实要删除吗', '<?php echo url('admin/del',array('id'=>$voi['id'])); ?>')" class="btn btn-danger btn-sm shiny">
