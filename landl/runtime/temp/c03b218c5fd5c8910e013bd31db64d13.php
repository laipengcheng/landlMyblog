...
<!--首页图片-->
<div class="other-img"><img src="/static/index/images/img03.jpg"></div>
<!--顶部结束-->
...
<!--左侧开始-->
    ...
    <div id="left-article">
        <h2 class="text-center"><?php echo $articles['title']; ?></h2>
        <h5 class="text-center">作者:<?php echo $articles['author']; ?>
            关键词:<a href="<?php echo url('Search/index',array('keywords'=>$articles['cateid'])); ?>"><?php echo $articles['cate']['catename']; ?></a>&nbsp;&nbsp;
            发布时间:<?php echo date("Y-m-d",$articles['time']); ?></h5>
